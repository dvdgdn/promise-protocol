# CONTRIBUTING.md — Proof-of-Contribution & Compensation
**No tokens. No wallets. No surprises.**

This document is the **front door for contributors** (engineers, designers, researchers). It explains **what work we pay for, how it’s accepted, when you get paid**, and how **Proof-of-Contribution (PCR) units** work for upside sharing and governance weight.

> For domain/governance spec authors, see: `GOVERNANCE.md` and `SPEC-CONTRIBUTING.md`.
